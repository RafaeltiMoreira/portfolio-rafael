    ...
    return (
        <div id="home" className="flex items-center justify-center flex-col py-20">
            <div className="text-center">
                ...
                <p className="text-md md:text-xl max-w-md mb-3 text-gray-600 dark:text-gray-300">Tenham uma ótima experiência explorando os exemplos de interfaces front-end que criei.</p>
