...
export default function WorksItens({ imgUrl, title, tech, workUrl }) {
    return (
        <a href={workUrl} target='_blank' rel='noreferrer' className='bg-slate-300 dark:bg-slate-800 rounded-lg overflow-hidden'>
